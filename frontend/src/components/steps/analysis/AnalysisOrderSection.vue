...
import DerivedColumnsPreviewTable from '@/components/analysis/DerivedColumnsPreviewTable.vue';
import ColumnMatchingGroupsPanel from '@/components/analysis/ColumnMatchingGroupsPanel.vue';
  ...
  <AppStepSection icon="pi-list" title="Analysis Summary">
    <template #action>
      <Button
        ...
        :aria-label="open ? 'Collapse analysis summary' : 'Expand analysis summary'"
        @click="open = !open"
      />
    </template>

    <div v-if="open" class="ui-analysis-order-body">
