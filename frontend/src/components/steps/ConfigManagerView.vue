...
import ConfigSavePanel from '@/components/config/ConfigSavePanel.vue';
import ConfigValidationReport from '@/components/config/ConfigValidationReport.vue';
...
const exportReport = useConfigExportReport();
const stepVm = useConfigManagerStep();
const customFilename = exportReport.customFilename;
const exportLoading = exportReport.exportLoading;
const exportError = exportReport.exportError;
...
function handleExport(): void {
  ...
  void exportReport.handleExport();
}
</script>
...
<template>
  <div class="step-shell ui-export-page">
      ...
      <div class="ui-export-compact">
        ...
        <div class="ui-export-actions">
          ...
          <Button
            ...
            severity="primary"
            size="large"
            class="ui-export-submit-btn justify-content-center"
    ...
    <ConfigSavePanel
      :defaultName="stepVm.defaultConfigName.value"
      @save="stepVm.handleSave"
      @saveToDb="stepVm.handleSaveToDb"
