...
import ColumnToggleList from '@/components/columns/ColumnToggleList.vue';
import ParameterForm from '@/components/params/ParameterForm.vue';
...
function handleSelectAll() {
  columnsStore.selectAll(columnNames.value);
}

function handleUpdateParameter(index: number, updates: Partial<Parameter>) {
  parametersStore.updateParameter(index, updates);
}
</script>
