...
import TokenFormulaEditor from '@/components/formulas/TokenFormulaEditor.vue';
...
import type { DerivedColumnDef, FormulaToken } from '@/types/domain';
...
const saveButtonRootPt = computed(() => {
  if (isDirty.value) return undefined;
  return {
    root: {
      style: {
