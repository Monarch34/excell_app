  ...
  <div class="ui-derived-columns-preview">
    <div class="ui-derived-columns-preview-head">
      <p class="ui-analysis-order-subpanel-note">
        Drag column headers left/right to reorder export columns. Preview shows first 10 rows.
      </p>
    </div>
          ...
          >
            ...
            >
              <div class="ui-derived-col-header-main">
                <i class="pi pi-bars ui-derived-col-drag" aria-hidden="true" title="Drag to reorder column"></i>
