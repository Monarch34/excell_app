...
import ChartBasicsSection from '@/features/charts/sections/ChartBasicsSection.vue';
import ChartAxesSection from '@/features/charts/sections/ChartAxesSection.vue';
import ChartStyleSection from '@/features/charts/sections/ChartStyleSection.vue';

const ChartBaselineDialog = defineAsyncComponent(
  () => import('@/features/charts/sections/ChartBaselineDialog.vue')
);
...
const { configDialogOpen, styleTitle, strokeLabel } = vm;
...
<template>
  <div class="chart-definition-form">
    ...
    <section v-if="chart.chartType" class="chart-collapsible">
      ...
      <div v-show="expanded.axes" class="chart-collapse-content">
        <ChartAxesSection
          ...
          hideHeading
          @openConfigure="configDialogOpen = true"
    ...
    <ChartBaselineDialog
      ...
      :chart="chart"
      @update:visible="(v: boolean) => (configDialogOpen = v)"
