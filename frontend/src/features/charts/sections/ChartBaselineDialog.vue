...
import type { AreaSpec, BaselineRegion, BaselineSpec, ChartSpec } from '@/shared/types/domain';
import BaselineRegionSelector from '@/features/charts/sections/baseline/BaselineRegionSelector.vue';
import InlineResetNumberField from '@/features/charts/common/InlineResetNumberField.vue';
