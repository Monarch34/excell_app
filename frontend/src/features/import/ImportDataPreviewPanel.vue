...
import DataPreviewTable from '@/features/import/DataPreviewTable.vue';
import MetadataPanel from '@/features/import/MetadataPanel.vue';
...
import type { ColumnDef, DatasetMetadata } from '@/shared/types/domain';
